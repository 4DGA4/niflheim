# Adtech Fragility Module Integration Guide

## Overview

The Adtech Fragility module demonstrates vulnerabilities in real-time bidding (RTB) ecosystems to data poisoning attacks. This educational tool shows how signal pollution and cookie sync disruption can degrade adtech system performance.
